...
//  * @param {*} logObject 
//  */
// function _LOG(message:string,logObject?:Error){
//   console.log(`************* [${message}] *************`);
...
//   FIN_BETA:string|undefined;
//   GOV:string|undefined;
//   GOV_BETA:string|undefined;
//   PU:string|undefined;
//   PU_BETA:string|undefined;
// }
...
//   private testPlatForm:ItestPlatForm;
  
  
//  constructor(targetNCP:string){
...
//   }
//   private async initialize({isHeadless,target}:initObject){
//     try{
//       _LOG('initialize');
...
//       // this.targetURL = this.testPlatForm[_target];
...
//     }
//   }
//   public async run(targetNCP:string){
//     //* Login Actions
//     console.time('login');
